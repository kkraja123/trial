...
public class InProgressFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        final AdapterForStudy itemsAdapter = new AdapterForStudy(InProgressFragment.this.getActivity(), todoArrayList);
        final RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.recycle);
        GridLayoutManager gridLayoutManager = new GridLayoutManager(InProgressFragment.this.getActivity(), 2);
